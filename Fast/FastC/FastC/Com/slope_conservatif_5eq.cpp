            ...
            if(idir<=2)
              {
               ...
               for (E_Int j = 0; j < jmax; j++)
                {
                  E_Int lr  = j       +sizefluR*5;
                  E_Int ld0 = j*2     +sizefluD*5;
                  E_Int ld1 = j*2 +1  +sizefluD*5;
            ...
            else if(idir<=4)
              {
               ...
               for (E_Int i = 0; i < imax; i++)
                {
                  E_Int lr  = i       +sizefluR*5;
                  E_Int ld0 = i*2     +sizefluD*5;
                  E_Int ld1 = i*2 +1  +sizefluD*5;
