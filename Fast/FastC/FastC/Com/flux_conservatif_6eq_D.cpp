               ...
               for (E_Int j = 0; j < jmax; j++)
                {
                 ...
                 fluxR[lr +sizefluR*5] = fluxD[ld0 +sizefluD*5];
                 fluxR[lr +sizefluR*5]+= fluxD[ld1 +sizefluD*5]*coefj;
                 fluxR[lr +sizefluR*5]+= fluxD[ld2 +sizefluD*5]*coefk;;
                 fluxR[lr +sizefluR*5]+= fluxD[ld3 +sizefluD*5]*coefj*coefk;
                }
               }
             }
            else if(idir<=4)
               ...
               for (E_Int i = 0; i < imax; i++)
                {
                 ...
                 fluxR[lr +sizefluR*5] = fluxD[ld0 +sizefluD*5];
                 fluxR[lr +sizefluR*5]+= fluxD[ld1 +sizefluD*5]*coefi;
                 fluxR[lr +sizefluR*5]+= fluxD[ld2 +sizefluD*5]*coefk;;
                 fluxR[lr +sizefluR*5]+= fluxD[ld3 +sizefluD*5]*coefi*coefk;
                }
               }
             }
            else 
               ...
               for (E_Int i = 0; i < imax; i++)
                {
                 ...
                 fluxR[lr +sizefluR*5] = fluxD[ld0 +sizefluD*5];
                 fluxR[lr +sizefluR*5]+= fluxD[ld1 +sizefluD*5]*coefi;
                 fluxR[lr +sizefluR*5]+= fluxD[ld2 +sizefluD*5]*coefj;;
                 fluxR[lr +sizefluR*5]+= fluxD[ld3 +sizefluD*5]*coefi*coefj;
                }
               }
             }
           }//2d/3d
