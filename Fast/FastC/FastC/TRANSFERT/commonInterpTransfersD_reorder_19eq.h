...
// #endif
    for (E_Int noind = pt_deb; noind < pt_fin; noind++)
    {
      ...
      ind111 = ind110+imdjmd;
      val0=0;val1=0;val2=0;val3=0;val4=0;val5=0;val6=0;val7=0;val8=0;val9=0;
      val10=0;val11=0;val12=0;val13=0;val14=0;val15=0;val16=0;val17=0;val18=0;
      if(K_FUNC::E_abs( ptrCoefs[ indCoef ]) > cutoff_coef)
       { 
        E_Int indCoefLoc= indCoef; E_Int indLoc = ind000;
        val0 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[0][indLoc];
        val1 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[1][indLoc];
        val2 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[2][indLoc];
        val3 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[3][indLoc];
        val4 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[4][indLoc];
        val5 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[5][indLoc];
        val6 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[6][indLoc];
        val7 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[7][indLoc];
        val8 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[8][indLoc];
        val9 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[9][indLoc];
        val10 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[10][indLoc];
        val11 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[11][indLoc];
        val12 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[12][indLoc];
        val13 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[13][indLoc];
        val14 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[14][indLoc];
        val15 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[15][indLoc];
        val16 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[16][indLoc];
        val17 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[17][indLoc];
        val18 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[18][indLoc];
       } 
      if(K_FUNC::E_abs( ptrCoefs[ indCoef+1 ]) > cutoff_coef)
       { 
        E_Int indCoefLoc= indCoef+1; E_Int indLoc = ind100;
        val0 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[0][indLoc];
        val1 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[1][indLoc];
        val2 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[2][indLoc];
        val3 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[3][indLoc];
      ...
      if(K_FUNC::E_abs( ptrCoefs[ indCoef+2 ]) > cutoff_coef)
       { 
        E_Int indCoefLoc= indCoef+2; E_Int indLoc = ind010;
        val0 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[0][indLoc];
        val1 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[1][indLoc];
        val2 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[2][indLoc];
        val3 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[3][indLoc];
      ...
      if(K_FUNC::E_abs( ptrCoefs[ indCoef+3 ]) > cutoff_coef)
       { 
        E_Int indCoefLoc= indCoef+3; E_Int indLoc = ind110;
        val0 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[0][indLoc];
        val1 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[1][indLoc];
        val2 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[2][indLoc];
        val3 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[3][indLoc];
      ...
      if(K_FUNC::E_abs( ptrCoefs[ indCoef+4 ]) > cutoff_coef)
       { 
        E_Int indCoefLoc= indCoef+4; E_Int indLoc = ind001;
        val0 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[0][indLoc];
        val1 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[1][indLoc];
        val2 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[2][indLoc];
        val3 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[3][indLoc];
      ...
      if(K_FUNC::E_abs( ptrCoefs[ indCoef+5 ]) > cutoff_coef)
       { 
        E_Int indCoefLoc= indCoef+5; E_Int indLoc = ind101;
        val0 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[0][indLoc];
        val1 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[1][indLoc];
        val2 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[2][indLoc];
        val3 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[3][indLoc];
      ...
      if(K_FUNC::E_abs( ptrCoefs[ indCoef+6 ]) > cutoff_coef)
       { 
        E_Int indCoefLoc= indCoef+6; E_Int indLoc = ind011;
        val0 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[0][indLoc];
        val1 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[1][indLoc];
        val2 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[2][indLoc];
        val3 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[3][indLoc];
      ...
      if(K_FUNC::E_abs( ptrCoefs[ indCoef+7 ]) > cutoff_coef)
       { 
        E_Int indCoefLoc= indCoef+7; E_Int indLoc = ind111;
        val0 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[0][indLoc];
        val1 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[1][indLoc];
        val2 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[2][indLoc];
        val3 += ptrCoefs[ indCoefLoc ]*vectOfDnrFields[3][indLoc];
      ...
      for (E_Int kk=0; kk<4; kk++)
        for (E_Int jj=0; jj<4; jj++)
          for (E_Int ii=0; ii<4; ii++)
          {
            ...
            E_Float ampli = ptrCoefs[ indCoef + ii]*ptrCoefs[ indCoef + jj+4]*ptrCoefs[ indCoef + kk+8];
            if(K_FUNC::E_abs(ampli) > cutoff_coef)
             { 
              val0 += ampli*vectOfDnrFields[0][indD];
              val1 += ampli*vectOfDnrFields[1][indD];
              val2 += ampli*vectOfDnrFields[2][indD];
              val3 += ampli*vectOfDnrFields[3][indD];
              val4 += ampli*vectOfDnrFields[4][indD];
              val5 += ampli*vectOfDnrFields[5][indD];
              val6 += ampli*vectOfDnrFields[6][indD];               
              val7 += ampli*vectOfDnrFields[7][indD];               
              val8 += ampli*vectOfDnrFields[8][indD];               
              val9 += ampli*vectOfDnrFields[9][indD];               
             val10 += ampli*vectOfDnrFields[10][indD];
             val11 += ampli*vectOfDnrFields[11][indD];
             val12 += ampli*vectOfDnrFields[12][indD];
             val13 += ampli*vectOfDnrFields[13][indD];
             val14 += ampli*vectOfDnrFields[14][indD];
             val15 += ampli*vectOfDnrFields[15][indD];
             val16 += ampli*vectOfDnrFields[16][indD];
             val17 += ampli*vectOfDnrFields[17][indD];
             val18 += ampli*vectOfDnrFields[18][indD];
             } 
          }
      vectOfRcvFields[0][noind] = val0;
      vectOfRcvFields[1][noind] = val1;
