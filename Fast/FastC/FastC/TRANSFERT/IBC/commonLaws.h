...
//==============================================================================
E_Float K_FASTC::logf(E_Float x, E_Float a, E_Float b, E_Float c, E_Float d) 
{
  return a*log(b*x)-d/x+c;
}
// derivee
E_Float K_FASTC::logfprime(E_Float x, E_Float a, E_Float d) 
{
  return a/x+d/(x*x);
}
//==============================================================================
...
//==============================================================================
E_Float K_FASTC::musker(E_Float x, E_Float a, E_Float b)
{
  E_Float ax = a*x;
  E_Float ax2 = ax*ax;
...
//==============================================================================
E_Float K_FASTC::muskerprime(E_Float x, E_Float a, E_Float b)
{
...
//==============================================================================
E_Float K_FASTC::fnutilde(E_Float nutilde, E_Float nut, E_Float rho, E_Float xmu)
{
...
E_Float K_FASTC::fnutildeprime(E_Float nutilde, E_Float nut, E_Float rho, 
                                   E_Float xmu)
{
  E_Float cv1 = 7.1; 
