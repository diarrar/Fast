...
C***********************************************************************
      subroutine fluroe_SA_o1_3dfull(ndom, ithread,
...
#include    "FastS/Compute/ROE/3dfull/fluFaceSA_o1_3dfull_k.for"   
...
!$OMP SIMD
        DO i = ind_loop(1), ind_loop(2)
            ...
            lvo= lt
            sens=1.
#include    "FastS/Compute/ROE/3dfull/fluFaceEuler_o1_3dfull_j.for"
#include    "FastS/Compute/ROE/3dfull/fluFaceSA_o1_3dfull_j.for"
...
!$OMP SIMD                                        
        DO i = ind_loop(1), ind_loop(2)
            ...
            lvo= lt
            sens=1.
#include    "FastS/Compute/ROE/3dfull/fluFaceEuler_o1_3dfull_i.for"
#include    "FastS/Compute/ROE/3dfull/fluFaceSA_o1_3dfull_i.for"
