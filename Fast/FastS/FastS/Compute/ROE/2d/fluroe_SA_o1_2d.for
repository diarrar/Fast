...
C***********************************************************************
      subroutine fluroe_SA_o1_2d(ndom, ithread,
...
!$OMP SIMD
        DO i = ind_loop(1), ind_loop(2)
            ...
            lvo= lt
            sens=1.
#include    "FastS/Compute/ROE/2d/fluFaceEuler_o1_2d_j.for"
#include    "FastS/Compute/ROE/2d/fluFaceSA_o1_2d_j.for"
...
!$OMP SIMD                                        
        DO i = ind_loop(1), ind_loop(2)
            ...
            lvo= lt
            sens=1.
#include    "FastS/Compute/ROE/2d/fluFaceEuler_o1_2d_i.for"
#include    "FastS/Compute/ROE/2d/fluFaceSA_o1_2d_i.for"
