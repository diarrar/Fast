...
C***********************************************************************
      subroutine fluroe_ale_SA_o1_3dcart(ndom, ithread,
...
!$OMP SIMD                                                
        DO i = ind_loop(1), ind_loop(2)                   
            ...
            lvo= lt                                       
            sens=1.                                       
#include    "FastS/Compute/ROE/3dcart/fluFaceEuler_ale_o1_3dcart_k.for"  
#include    "FastS/Compute/ROE/3dcart/fluFaceSA_ale_o1_3dcart_k.for"   
...
!$OMP SIMD
        DO i = ind_loop(1), ind_loop(2)
            ...
            lvo= lt
            sens=1.
#include    "FastS/Compute/ROE/3dcart/fluFaceEuler_ale_o1_3dcart_j.for"
#include    "FastS/Compute/ROE/3dcart/fluFaceSA_ale_o1_3dcart_j.for"
...
!$OMP SIMD                                        
        DO i = ind_loop(1), ind_loop(2)
            ...
            lvo= lt
            sens=1.
#include    "FastS/Compute/ROE/3dcart/fluFaceEuler_ale_o1_3dcart_i.for"
#include    "FastS/Compute/ROE/3dcart/fluFaceSA_ale_o1_3dcart_i.for"
