...
C***********************************************************************
      subroutine fluroe_SA_o3sc_3dcart(ndom, ithread,
...
!$OMP SIMD                                                
        DO i = ind_loop(1), ind_loop(2)                   
            ...
            lvo= lt                                       
            sens=1.                                       
#include    "FastS/Compute/ROE/3dcart/fluFaceEuler_o3sc_3dcart_k.for"  
#include    "FastS/Compute/ROE/3dcart/fluFaceSA_o3sc_3dcart_k.for"   
...
!$OMP SIMD
        DO i = ind_loop(1), ind_loop(2)
            ...
            lvo= lt
            sens=1.
#include    "FastS/Compute/ROE/3dcart/fluFaceEuler_o3sc_3dcart_j.for"
#include    "FastS/Compute/ROE/3dcart/fluFaceSA_o3sc_3dcart_j.for"
...
!$OMP SIMD                                        
        DO i = ind_loop(1), ind_loop(2)
            ...
            lvo= lt
            sens=1.
#include    "FastS/Compute/ROE/3dcart/fluFaceEuler_o3sc_3dcart_i.for"
#include    "FastS/Compute/ROE/3dcart/fluFaceSA_o3sc_3dcart_i.for"
