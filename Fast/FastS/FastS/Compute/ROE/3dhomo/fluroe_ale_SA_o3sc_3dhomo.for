...
C***********************************************************************
      subroutine fluroe_ale_SA_o3sc_3dhomo(ndom, ithread,
...
!$OMP SIMD                                                
        DO i = ind_loop(1), ind_loop(2)                   
            ...
            lvo= lt                                       
            sens=1.                                       
#include    "FastS/Compute/ROE/3dhomo/fluFaceEuler_ale_o3sc_3dhomo_k.for"  
#include    "FastS/Compute/ROE/3dhomo/fluFaceSA_ale_o3sc_3dhomo_k.for"   
...
!$OMP SIMD
        DO i = ind_loop(1), ind_loop(2)
            ...
            lvo= lt
            sens=1.
#include    "FastS/Compute/ROE/3dhomo/fluFaceEuler_ale_o3sc_3dhomo_j.for"
#include    "FastS/Compute/ROE/3dhomo/fluFaceSA_ale_o3sc_3dhomo_j.for"
...
!$OMP SIMD                                        
        DO i = ind_loop(1), ind_loop(2)
            ...
            lvo= lt
            sens=1.
#include    "FastS/Compute/ROE/3dhomo/fluFaceEuler_ale_o3sc_3dhomo_i.for"
#include    "FastS/Compute/ROE/3dhomo/fluFaceSA_ale_o3sc_3dhomo_i.for"
