C ** GPU Template: Master template for GPU-enabled flux computations
C ** This file contains OpenMP GPU offloading directives
...
#ifdef _OPENMP_GPU_OFFLOAD
            l  = inddm_gpu(i,j,k)              !3D only
            lt = indmtr_gpu(i,j,k)              !3D only
#else
