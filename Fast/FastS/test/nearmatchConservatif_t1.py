...
t,tc = FC_IBM.prepareIBMData(tb, None, None, vmin=15, snearsf=snearsf, frontType=frontType, expand=2, check=False, cleanCellN=True)

FastC._buildConservativeFlux(t, tc, verbose=0)
