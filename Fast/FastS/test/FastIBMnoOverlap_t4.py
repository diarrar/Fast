...
tb = C.convertFile2PyTree("../../Fast/test/naca1DEuler.cgns")
FastIBM._snearFactor(tb, 0.1)
# Prepare
t,tc = FC_IBM.prepareIBMData(tb, None, None, vmin=21, frontType=1, expand=2, check=True, cleanCellN=False)
...
#C.convertPyTree2File(tc,'verifc.cgns')
#tc = C.convertFile2PyTree(LOCAL+'/tc.cgns')
#t  = C.convertFile2PyTree(LOCAL+'/t.cgns')

FastC._attributeNoPassTransfer(tc, verbose=0)
