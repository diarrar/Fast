...
void compute_sij( E_Float**& ipt_ro      , E_Float**& iptS     , E_Float**& ipt_vol   ,E_Int*& param_int_tc,
  ...
  E_Int gsdr3(
	      ...
	      E_Float**& iptdrodm_trans  , E_Int** int_tc              , E_Float** real_tc          ,
              E_Int*& ipt_linelets_int   , E_Float*& ipt_linelets_real , E_Int& taille_tabs         , E_Float*& stock          , E_Float*& drodmstock  ,
